 ...
 *
 * Each person has an inventory that holds ShardObjects. Yes, that means
...
public class Person implements ShardObject, Owner {
    ...
    /**
     * Automatically adds the Person to the Room's object list.
     */
    public Person(String name, Owner location) {
        this.name = name;
